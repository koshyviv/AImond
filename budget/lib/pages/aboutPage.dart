        ...
        child: Column(
          ...
          children: [
            _buildTappable(
              context: context,
              isExternalLink: true,
              onTap: () => openUrl("https://github.com/jameskokoska/AImond"),
            ...
            _buildTappable(
              context: context,
              isExternalLink: true,
              onTap: () => openUrl("https://aimondapp.web.app/faq.html"),
              icon: appStateSettings["outlinedIcons"]
            ...
            _buildTappable(
              context: context,
              isExternalLink: true,
              onTap: () => openUrl("http://aimondapp.web.app/policy.html"),
              icon: appStateSettings["outlinedIcons"]
...
class AboutDeepLinking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AboutInfoBox(
      ...
      showLink: false,
      link:
          "https://github.com/jameskokoska/AImond?tab=readme-ov-file#app-links",
      list: [
