...
String getChangelogString() {
  return """
    ...
    When tapping support, AImond Pro options highlight
    ...
    < 3.8.0
    AImond pro background now extends past scrollable area - support for (i) over-scroll
